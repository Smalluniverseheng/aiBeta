...
const SB = (() => {
  ...
  const SETTINGS_WHITELIST = [
    'novelSources', 'novelHistory', 'novelBookmarks', 'novelSettings',
    'paintHistory', 'videoHistory', 'videoTasks',
    'comicSources', 'comicHistory', 'comicBookmarks',
    'shortVideoHistory', 'shortVideoFavorites',
    'videoHubHistory', 'videoHubFavorites',
    'themeSettings','theme', 'lang', 'voiceSettings', 'toolsEnabled', 'currentModelId', 'debatePreset', 'collabRoles', 'tokenSort', 'autoSpeak'];
